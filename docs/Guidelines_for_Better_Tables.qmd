...
![Table Parts \@jschwabish, 2020](images/table_parts.jpg)[^1] Figure 1. Table Parts (Schwabish, 2020)

[^1]: @jschwabish Tweet Aug 3, 2020
...
### Rule 2: Use subtle Dividers rathen than heavy gridlines

-   tab_style()\
-   see stackoverflow to conditionally fill tab_style[^2]

[^2]: https://stackoverflow.com/questions/63944953/how-to-conditionally-format-a-cell-in-a-gt-table-based-on-the-value-of-the-cel
...
[Format values as a percentage is not working](https://gt.rstudio.com/reference/fmt_percent.html)[^3]

[^3]: Not working because the data source is a table and not a data frame
